          ...
          >
            <label :class="suit('label')">
              ...
              <span
                v-else
                :class="suit('labelText')"
              >{{item.label == 0 ? 'Inactiva' : 'Activa'}}</span>
...
<script>
import { createWidgetMixin } from '@vue-instantsearch/mixins/widget';
import { createPanelConsumerMixin } from '@vue-instantsearch/mixins/panel';
import { createSuitMixin } from '@vue-instantsearch/mixins/suit';
import { connectRefinementList } from '@node/instantsearch.js/es/connectors';
import SearchInput from '@vue-instantsearch/components/SearchInput.vue';
import AisHighlight from '@vue-instantsearch/components/Highlight.vue';
